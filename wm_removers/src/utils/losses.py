...
class VGG16FeatureExtractor(nn.Module):
    def __init__(self):
        ...
        vgg16 = models.vgg16()  # 创建一个空的VGG16模型
        checkpoint = torch.load("/home/coolboy2/huangwenhong/SplitNet/pretrainedVGG/vgg16-397923af.pth")
        vgg16.load_state_dict(checkpoint)  # 将预训练权重加载到VGG模型中
